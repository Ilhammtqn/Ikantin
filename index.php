    ...
    <div class="container" style="margin-top:50px;">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="container">
                    <div class="col-md-10">
                        <h4>Klik di sini untuk pembelian <button type="button" class="btn btn-success" name="button" data-toggle="modal" data-target="#buy">
       ...
       <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border-radius: 5px 5px 0px 0px;">
                <button type="button" class="close" data-dinamis="modal" arial-hidden="true"> &times; </button>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="Keduanya()" class="btn btn-success" style="float:left;"> Bakso & Bakwan</button>
            </form>
            </div>
        </div>
       </div>
